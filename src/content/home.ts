...
export const homeFaq = [
  ...
  },
  {
    ...
    answer:
      "Формат поддержки зависит от программы. На курсе «ТОП мастер универсал — повышение квалификации» моя поддержка остаётся навсегда; для онлайн-курса «Логика материалов» поддержку можно продлевать за 1 000 ₽; период уточните у Елены.",
  },
  {
    question: "Даётся ли сертификат после обучения?",
    answer:
      "Да. После живых курсов выдаётся сертификат: после «ТОП мастер универсал — 2 ступень» вы получаете 2 сертификата, после других живых курсов — 1. После сдачи предусмотренных уроков на онлайн-обучении также выдаётся сертификат.",
  },
  {
